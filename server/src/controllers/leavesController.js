// src/controllers/leavesController.js
...
export const getPendingLeavesForApprover = async (req, res) => {
  try {
    const leaves = await Leave.findAll({
      where: {
...
export const approveLeave = async (req, res) => {
    ...
    try {
      ...
      // If the leave request doesn't exist or isn't pending, return a 404 error
      if (!leave) {
 ...
 */
export const getLeavesForApprover = async (req, res) => {
