    ...
    return (
      <SafeAreaView className={`flex-1 ${isLightTheme ? "bg-white" : "bg-slate-900"}`} edges={["top"]}>
        <View className="flex-1 justify-center items-center">
          ...
          <Text className={`mt-4 ${isLightTheme ? "text-slate-700" : "text-slate-300"}`}>Loading Payrate Settings...</Text>
        </View>
      </SafeAreaView>
    );
  }
  ...
  return (
    <SafeAreaView className={`flex-1 ${isLightTheme ? "bg-white" : "bg-slate-900"}`} edges={["top"]}>
      <View className="flex-row items-center px-4 py-4">
        ...
        <Text className={`text-xl font-bold ${isLightTheme ? "text-slate-800" : "text-white"}`}>Payrate Settings</Text>
      </View>
      <View className="flex-1 px-4 mt-4">
        <Text className={`font-semibold mb-1 ${isLightTheme ? "text-slate-800" : "text-slate-300"}`}>Select User</Text>
        <DropDownPicker
          open={userPickerOpen}
        ...
        />
        <Text className={`font-semibold mt-4 mb-1 ${isLightTheme ? "text-slate-800" : "text-slate-300"}`}>Pay Type</Text>
        <DropDownPicker
          open={payTypeOpen}
          value={payTypeValue}
          items={payTypeItems}
          ...
          placeholderStyle={{ color: isLightTheme ? "#6B7280" : "#9CA3AF" }}
        />
        <Text className={`font-semibold mb-1 mt-4 ${isLightTheme ? "text-slate-800" : "text-slate-300"}`}>Rate (USD)</Text>
