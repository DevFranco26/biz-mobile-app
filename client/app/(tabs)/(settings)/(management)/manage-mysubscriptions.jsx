              ...
              <View className="flex-row mt-6 ml-auto">
                {!isFreePlan && (
                  <Pressable onPress={handleCancel} className="mr-4 p-3 rounded-lg">
                    <Text className={`${isLightTheme ? 'text-slate-700' : 'text-slate-300'} font-semibold`}>
                      Cancel
                    </Text>
                  </Pressable>
                )}
                  ...
                  return (
                    ...
                    >
                      ...
                      {selectedPlan?.id === plan.id && !cannotDowngrade && (
                        <View className="mt-2">
                          {plan.description && (
                            <Text className={`text-xs ${isLightTheme ? 'text-slate-600' : 'text-slate-400'}`}>
                              Description: {plan.description}
                            </Text>
                          )}
                          <Text className={`text-sm mt-1 ${isLightTheme ? 'text-slate-600' : 'text-slate-400'}`}>
                            Features:
                          </Text>
