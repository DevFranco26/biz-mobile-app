  ...
  return (
    ...
    >
      <View className="px-4 py-2">
            ...
            <View className="flex-row items-center ml-auto space-x-3">
              ...
              >
                <FontAwesome5
                  name="arrow-left"
                  size={20}
                  color={isLightTheme ? '#374151' : '#CBD5E1'}
                />
              </Pressable>
              <Pressable
                onPress={handleNext}
        ...
        >
          <Text className={`font-medium ${isLightTheme ? 'text-slate-700' : 'text-slate-300'}`}>
            Total Hours:
          </Text>
        ...
        {loading ? (
          ...
          shiftLogs.map((log, index) => {
            ...
            return (
              <View
                key={index}
                className={`p-4 rounded-lg mb-3 ${isLightTheme ? 'bg-slate-100' : 'bg-slate-800'}`}
              >
                ...
                <View className="flex-row items-center mt-2">
                  <Ionicons
                    name="cafe"
                    size={16}
                    color={isLightTheme ? '#0EA5E9' : '#38BDF8'}
                  />
                ...
                <View className="flex-row items-center mt-1">
                  <Ionicons
                    name="fast-food"
                    size={16}
                    color={isLightTheme ? '#FBBF24' : '#FCD34D'}
                  />
                  <Text className={`ml-2 text-sm ${isLightTheme ? 'text-slate-600' : 'text-slate-400'}`}>
