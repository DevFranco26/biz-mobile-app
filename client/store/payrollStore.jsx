  ...
  fetchAllPayroll: async (token) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        set({ error: data.message || 'Failed to fetch payroll.', loading: false });
        Alert.alert('Error', data.message || 'Failed to fetch payroll.');
      }
    } catch (error) {
      set({ error: 'An error occurred while fetching payroll.', loading: false });
  ...
  fetchMyPayroll: async (token) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        set({ error: data.message || 'Failed to fetch my payroll.', loading: false });
  ...
  fetchPayrollSettings: async (token) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        set({ error: data.message || 'Failed to fetch payroll settings.', loading: false });
        Alert.alert('Error', data.message || 'Failed to fetch payroll settings.');
      }
    } catch (error) {
      set({ error: 'An error occurred while fetching payroll settings.', loading: false });
  ...
  updatePayrollSettings: async (token, { cutoffCycle, currency, overtimeRate }) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        set({ error: data.message || 'Failed to update payroll settings.', loading: false });
  ...
  createOrUpdatePayRate: async (token, userId, { payType, rate }) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        set({ error: data.message || 'Failed to set pay rate.', loading: false });
  ...
  calculatePayroll: async (token, payload) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        set({ error: data.message || 'Failed to calculate payroll.', loading: false });
